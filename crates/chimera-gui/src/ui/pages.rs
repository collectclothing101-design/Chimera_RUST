...
pub fn ph(ui: &mut egui::Ui, idx: &str, title: &str, sub: &str) {
    ui.horizontal(|ui| {
        ui.vertical(|ui| {
...
pub fn sh(ui: &mut egui::Ui, label: &str) {
    ui.horizontal(|ui| {
...
pub fn jb_hd(ui: &mut egui::Ui, label: &str) {
    ui.horizontal(|ui| {
        ...
        ui.painter().line_segment(
            ...
            egui::Stroke::new(1.0_f32, Color32::from_rgba_premultiplied(255,255,255,26)));
...
pub fn btn_s(ui: &mut egui::Ui, label: &str) -> bool {
    ui.add(egui::Button::new(RichText::new(label).size(10.0).color(C::T1))
        ...
        .stroke(egui::Stroke::new(1.0_f32, Color32::from_rgba_premultiplied(255,255,255,18)))
        .corner_radius(8).min_size(egui::vec2(0.0,30.0))).clicked()
}

/// .btn .bd — danger red button
pub fn btn_d(ui: &mut egui::Ui, label: &str) -> bool {
    ui.add(egui::Button::new(RichText::new(label).size(10.0).color(C::R))
        .fill(C::RBG).stroke(egui::Stroke::new(1.0_f32,C::RBR))
        .corner_radius(8).min_size(egui::vec2(0.0,30.0))).clicked()
}
...
fn btn_p_wide(ui: &mut egui::Ui, label: &str) -> bool {
    ui.add_sized([ui.available_width(), 42.0],
        egui::Button::new(RichText::new(label).size(11.0).strong().color(Color32::from_rgb(3,1,0)))
            .fill(C::A).stroke(egui::Stroke::new(1.0_f32,C::AH)).corner_radius(8)).clicked()
}
...
fn fi(ui: &mut egui::Ui, val: &mut String, hint: &str) {
    egui::Frame::NONE
        ...
        .stroke(egui::Stroke::new(1.0_f32, Color32::from_rgba_premultiplied(255,255,255,20)))
...
pub fn kv(ui: &mut egui::Ui, k: &str, v: &str, col: Color32, mono: bool, last: bool) {
    ui.horizontal(|ui| {
...
pub fn chip_g(ui: &mut egui::Ui, label: &str) {
    egui::Frame::NONE.fill(C::GBG).stroke(egui::Stroke::new(1.0_f32,C::GBR))
    ...
    ui.columns(2, |cols| {
        ...
        for (i, col) in cols.iter_mut().enumerate() {
            ...
            egui::Frame::NONE
                ...
                .stroke(egui::Stroke::new(1.0_f32, if on { C::A18 } else { C::LN }))
...
pub fn render_devices(ui: &mut egui::Ui, state: &mut AppState, _op_tx: &Sender<OperationRequest>) {
    ...
    match state.devices_tab {
        ...
        1 => {
            ...
            empty(ui, "\u{25c8}", "ADB \u{00b7} No Connected Devices",
                if state.adb_ok {
...
pub fn render_utilities(ui: &mut egui::Ui, state: &mut AppState, _op_tx: &Sender<OperationRequest>) {
    ...
    match state.utilities_tab {
        ...
        _ => { card(ui, |ui| {
            ...
            ui.add_space(9.0);
            egui::Frame::NONE.fill(C::S00).stroke(egui::Stroke::new(1.0_f32,C::LN)).corner_radius(8)
                .show(ui, |ui| {
...
fn evdiv(ui: &mut egui::Ui) {
    ...
    if ui.is_rect_visible(r) {
        ui.painter().line_segment([r.left_top(),r.left_bottom()], egui::Stroke::new(1.0_f32,C::LN));
    }
}
